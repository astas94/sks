...
?>
	...
	<div class="form-horizontal">
		<fieldset>
		<legend> <?php echo JText::_('COM_BOOKPRO_CONTACT_DETAIL')?></legend>
...
<?php if ($config->get('rs_midlename', 1)){?>
			<div class="control-group">
				...
				<div class="controls">
					...
					value="<?php echo isset($this->customer->midlename)?$this->customer->midlename:null ?>" placeholder="<?php echo JText::_( 'COM_BOOKPRO_CUSTOMER_MIDLENAME' ); ?>"/>
				</div>
			</div>
		<?php } ?>
		...
		<?php }  ?>
			<div class="control-group">
				...
				value="<?php echo isset($this->customer->email)?$this->customer->email:null ?>" placeholder="<?php echo JText::_( 'COM_BOOKPRO_CUSTOMER_EMAIL' ); ?>" />
				</div>
			</div>
