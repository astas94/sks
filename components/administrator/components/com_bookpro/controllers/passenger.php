...
class BookproControllerPassenger extends JControllerForm
{
	...
	public function save($key = null, $urlVar = null)
	{
		...
		$dataSeat=$model->getSeatById();
		$oldSeat=$dataSeat->seat;
		...
		$data  = $this->input->post->get('jform', array(), 'array');
	 	...
	 	$data['notes']=(str_replace(strstr( $data['notes'],'('), '', $data['notes'])); 
	 
	 
		if($oldSeat != $data['seat']){
			//$data['notes'] = str_replace('{%}', '', $data['notes']);
			
		$data['notes']=$data['notes']."(".JText::_('COM_BOOKPRO_CHANGE_SEAT').$oldSeat.'->' .$data['seat'].")";
		}
